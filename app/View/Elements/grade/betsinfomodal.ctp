<!--BEGIN MODAL FADE-->
<div class="modal" id="betsInfoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 400px;">
                <div id="bim_headerTableDiv">
                    <table id="bim_headerTable" class="table table-bordered  table-striped table-hover">
                        <tr>
